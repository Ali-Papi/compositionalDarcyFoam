...
Application
    quaternaryNsCompositionalDarcyFoam

Description
    Multiphase solver for porous media for a quaternary system of CO2, H2O, Na and Cl with the interaction between the phases,
    i.e., water evaporation in gas and CO2 dissolution in water, with solid salt but no reaction.
